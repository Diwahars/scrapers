...
def initialize():
	output = open("SwimOutlet.csv","wb")
	mywriter = unicodecsv.writer(output)
	output.write('Item Type,Product Name,Brand Name,Price,Retail Price,Sale Price,Product Code/SKU,Category,Bin Picking Number,Product Description,'
