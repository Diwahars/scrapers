...
from assignment_2.items import PBItem
...
class Spider(CrawlSpider):
    ...
    start_urls = [
        # 'http://www.performancebike.com/bikes/SubCategory_10052_10551_400038_-1_400002_400002',
        ...
        'http://www.performancebike.com/bikes/SubCategory_10052_10551_400317_-1_400001_400306'
    ]

    # rules = (
    #     Rule(SgmlLinkExtractor(restrict_xpaths=('(//*[@id="snVerticalMenu"]/li)[position() > 1 and not(position() = last())]//h3/a/@href',)), callback="parse_category_initial" , follow= True),
    # )
